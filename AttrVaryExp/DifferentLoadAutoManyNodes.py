...
for ur in updateRate:
    for attr in numAttr:
        for scheme in schemeTypes:
            ...
            cmd = '/home/ayadav/RunContextService.py '+str(scheme)+' '+str(attr)
            os.system(cmd)
            # sleep for 2 mins for system to start
            time.sleep(100)
            
            # start update load
            cmd = '/home/ayadav/StartUpdateLoad.py '+str(scheme)+' '+str(ur)+' '+str(ur*2)+' '+str(attr)
            os.system(cmd)
            ...
            # start update load
            cmd = '/home/ayadav/StartQueryLoad.py '+str(scheme)+' '+str(ur)+' '+str(ur*2)+' '+str(attr)
            os.system(cmd)
