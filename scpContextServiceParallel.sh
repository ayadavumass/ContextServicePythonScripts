...
cat contextServiceList.txt | /usr/local/bin/parallel -j+100 scp -q -oStrictHostKeyChecking=no -oConnectTimeout=5 -i ~/privatekey/id_rsa ~/context-nodoc-0.1-2014-12-06.jar plabNodesInfo.txt runContextServiceOnNode.sh umass_nameservice@{}:
